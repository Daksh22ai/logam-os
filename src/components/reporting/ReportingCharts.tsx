        ...
        <div className="flex flex-col items-center justify-center gap-3.5 flex-1">
          <div className="relative w-24 h-24">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              ...
              <span className="text-[13px] font-bold font-mono">₹4.0L</span>
            </div>
          </div>
          <div className="flex flex-col gap-1.5 w-full max-w-[140px]">
            <div className="flex items-center gap-1.5 text-[11px] text-t2">
              <div className="w-[7px] h-[7px] rounded-full bg-acc" />
              Meta
              <div className="ml-auto font-semibold text-t1 font-mono">₹2.2L</div>
            </div>
            <div className="flex items-center gap-1.5 text-[11px] text-t2">
              <div className="w-[7px] h-[7px] rounded-full bg-blu" />
              Google
              <div className="ml-auto font-semibold text-t1 font-mono">₹1.8L</div>
            </div>
          </div>
        </div>
      </ChartCard>
