...
const MOCK_BRANDS = [
  { id: 'hobby', name: 'Hobby India', platform: ['Meta', 'Google'] },
  { id: 'fitness', name: 'Fitness Fox', platform: ['Meta'] },
  { id: 'nova', name: 'Nova Jewels', platform: ['Meta'] },
  { id: 'sahajanand', name: 'Sahajanand Elite', platform: ['Meta', 'Google'] },
]
